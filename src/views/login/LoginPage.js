              ...
              <Col className="ml-auto mr-auto mt-5" md="4">
                <Form className="login-form" onSubmit={this.handleSubmit}>
                    ...
                    <FormGroup className="mt-2">
                      ...
                      <Input type="email" name="email" id="email" placeholder="mario@unibz.it" onChange={(e) => {this.setState({userEmail: e.target.value})}} />
                    </FormGroup>
                    <FormGroup className="mt-2">
                      <Label for="examplePassword">Password</Label>
                      <Input type="password" name="password" id="password" placeholder="*********" onChange={(e) => {this.setState({userPassword: e.target.value})}} />
                    </FormGroup>
